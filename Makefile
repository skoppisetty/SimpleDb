...
main: Record.o Comparison.o ComparisonEngine.o Schema.o File.o y.tab.o lex.yy.o  BigQ.o Pipe.o DBFile.o RelOp.o Function.o HeapFile.o SortedFile.o Statistics.o ParseNode.o main.o
	$(CC) -o $(BIN)main $(BIN)Record.o $(BIN)Comparison.o $(BIN)ComparisonEngine.o $(BIN)Schema.o $(BIN)File.o $(BIN)y.tab.o $(BIN)lex.yy.o $(BIN)RelOp.o $(BIN)Function.o  $(BIN)BigQ.o $(BIN)Pipe.o $(BIN)HeapFile.o $(BIN)SortedFile.o $(BIN)DBFile.o $(BIN)Statistics.o $(BIN)ParseNode.o $(BIN)main.o -lfl $(LDFLAGS)
...
ParseNode.o: $(SOURCE)ParseNode.cc
	$(CC) -g -c  $< -o $(BIN)$@ $(LDFLAGS)
